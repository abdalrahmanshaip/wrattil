...
const GroupAdmins = () => {
  ...
  const handleDelete = async (adminId: number) => {
    ...
    setIsDeleting(true)
    try {
      await API.delete(`/groups/${groupId}/admins/${adminId}`)
  ...
  const onSubmit = async (data: z.infer<typeof AddAdminSchema>) => {
    setIsAdding(true)
    try {
      await API.post(`/groups/${groupId}/admins`, data)
      form.reset()
    ...
    <Card dir="rtl">
      <CardHeader>
        <div className="flex justify-between items-center">
          <CardTitle className="text-2xl">مشرفو المجموعة</CardTitle>
          <Form {...form}>
            <form
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>إضافة مشرف إلى المجموعة</FormLabel>
                    <FormControl>
                      <Input
                        type="email"
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                هل تريد حذف هذا المشرف من المجموعة؟ لا يمكن التراجع.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
